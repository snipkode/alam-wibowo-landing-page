    ...
    <section id="showreel" className="py-24 bg-cinematic-black">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16">
          {/* Official Showreel */}
          <div>
            <h2 className="text-gold uppercase tracking-[0.2em] text-sm mb-4">{t.video.official}</h2>
            <h3 className="text-3xl md:text-4xl font-serif font-bold text-white mb-6">{t.video.showreel}</h3>
            ...
            <div className="space-y-4">
              <h4 className="text-white font-bold uppercase tracking-widest text-xs">{t.video.highlights}</h4>
          ...
          {/* Introduction Video */}
          <div>
            <h2 className="text-gold uppercase tracking-[0.2em] text-sm mb-4">{t.video.intro}</h2>
            <h3 className="text-3xl md:text-4xl font-serif font-bold text-white mb-6">{t.video.profile}</h3>
            <div className="aspect-video bg-neutral-900 mb-6 relative group overflow-hidden border border-white/5">
              <iframe 
                className="w-full h-full"
                src="https://www.youtube.com/embed/dQw4w9WgXcQ" // Placeholder
            ...
            <div className="space-y-4">
              <h4 className="text-white font-bold uppercase tracking-widest text-xs">{t.video.contents}</h4>
